        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="panel panel-default detail">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h2><b>Graduation</b><b class="pull-right">2016 - 2020</b></h2>
                        </div>

                    </div>
                    <hr style="margin-top:0">

                    <!--detail of KNIT start-->
                    <div class="row">
                        <div class="col-xs-12">
                            <p class="title3">
            ...
            <!--indermediate career Start-->
            <div class="col-xs-12">
                <div class="panel panel-default detail">

                    <div class="row">
                        <div class="col-xs-12">
                            <h2><b>Intermediate</b><b class="pull-right">2013 - 2015</b></h2>
                        </div>
            ...
            <div class="col-xs-12">
                <div class="panel panel-default detail">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h2><b>Highschool and Primary School</b><b class="pull-right">2006 - 2013</b></h2>
                        </div>
