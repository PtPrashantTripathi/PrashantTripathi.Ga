                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li <?php if ($nav==2 ) echo 'class="active"';?> ><a href="/aboutme/"><i class="mdi mdi-account-circle"></i>&nbsp;About me</a></li>
                                    ...
                                    <li <?php if ($nav==5 ) echo 'class="active"';?> ><a href="/achievements/"><i class="mdi mdi-certificate"></i>&nbsp;Achievements</a></li>
                                    <li <?php if ($nav==6 ) echo 'class="active"';?> ><a href="/contact/"><i class="mdi mdi-contact-mail"></i>&nbsp;Contact</a></li>
